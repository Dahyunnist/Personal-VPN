...
//                 }},
//                 {"certs", {
//                     {"client_crt", read_file(CLIENT_CRT_PATH)},
//                     {"client_key", read_file(CLIENT_KEY_PATH)},
//                     {"server_crt", read_file(CERTIFICATE_PATH)}
//                 }}
//             };
...
int main(int argc, char* argv[]) {
    ...
    vpn_global::port = 0;
    vpn_global::port = static_cast<unsigned short>(std::stoi(argv[1]));
    ...
    try {
        ...
        SystemConfig::setup_iptables_nat(vpn_config::TUN_NETWORK, vpn_config::PHYSICAL_NIC);
