...
public:
    ...
    QLineEdit *caCertPath;
    QPushButton *browseCaCert;
    QLabel *label_5;
    QHBoxLayout *horizontalLayout_2;
    QLineEdit *clientCertPath;
    QPushButton *browseClientCert;
    QLabel *label_6;
    QHBoxLayout *horizontalLayout_3;
    QLineEdit *clientKeyPath;
    QPushButton *browseClientKey;
    QGroupBox *tunGroup;
    QHBoxLayout *horizontalLayout_4;
    QComboBox *tunInterface;
    QPushButton *refreshInterfaces;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, routeIp);
        ...
        caCertPath = new QLineEdit(certGroup);
        caCertPath->setObjectName("caCertPath");

        horizontalLayout->addWidget(caCertPath);

        browseCaCert = new QPushButton(certGroup);
        browseCaCert->setObjectName("browseCaCert");

        horizontalLayout->addWidget(browseCaCert);


        formLayout_2->setLayout(0, QFormLayout::FieldRole, horizontalLayout);

        label_5 = new QLabel(certGroup);
        ...
        clientCertPath = new QLineEdit(certGroup);
        clientCertPath->setObjectName("clientCertPath");

        horizontalLayout_2->addWidget(clientCertPath);

        browseClientCert = new QPushButton(certGroup);
        browseClientCert->setObjectName("browseClientCert");

        horizontalLayout_2->addWidget(browseClientCert);


        formLayout_2->setLayout(1, QFormLayout::FieldRole, horizontalLayout_2);

        label_6 = new QLabel(certGroup);
        ...
        clientKeyPath = new QLineEdit(certGroup);
        clientKeyPath->setObjectName("clientKeyPath");

        horizontalLayout_3->addWidget(clientKeyPath);

        browseClientKey = new QPushButton(certGroup);
        browseClientKey->setObjectName("browseClientKey");

        horizontalLayout_3->addWidget(browseClientKey);
        ...
        tunGroup = new QGroupBox(tab);
        tunGroup->setObjectName("tunGroup");
        horizontalLayout_4 = new QHBoxLayout(tunGroup);
        horizontalLayout_4->setObjectName("horizontalLayout_4");
        tunInterface = new QComboBox(tunGroup);
        tunInterface->setObjectName("tunInterface");

        horizontalLayout_4->addWidget(tunInterface);

        refreshInterfaces = new QPushButton(tunGroup);
        refreshInterfaces->setObjectName("refreshInterfaces");

        horizontalLayout_4->addWidget(refreshInterfaces);


        verticalLayout_3->addWidget(tunGroup);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        serverGroup->setTitle(QCoreApplication::translate("MainWindow", "\346\234\215\345\212\241\345\231\250\350\256\276\347\275\256", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "\346\234\215\345\212\241\345\231\250IP:", nullptr));
        serverIp->setText(QCoreApplication::translate("MainWindow", "172.20.68.63", nullptr));
        label_2->setText(QCoreApplication::translate("MainWindow", "\347\253\257\345\217\243:", nullptr));
        serverPort->setText(QCoreApplication::translate("MainWindow", "10043", nullptr));
        ...
        certGroup->setTitle(QCoreApplication::translate("MainWindow", "\350\257\201\344\271\246\351\205\215\347\275\256", nullptr));
        label_4->setText(QCoreApplication::translate("MainWindow", "CA\350\257\201\344\271\246:", nullptr));
        browseCaCert->setText(QCoreApplication::translate("MainWindow", "\346\265\217\350\247\210", nullptr));
        label_5->setText(QCoreApplication::translate("MainWindow", "\345\256\242\346\210\267\347\253\257\350\257\201\344\271\246:", nullptr));
        browseClientCert->setText(QCoreApplication::translate("MainWindow", "\346\265\217\350\247\210", nullptr));
        label_6->setText(QCoreApplication::translate("MainWindow", "\345\256\242\346\210\267\347\253\257\345\257\206\351\222\245:", nullptr));
        browseClientKey->setText(QCoreApplication::translate("MainWindow", "\346\265\217\350\247\210", nullptr));
        tunGroup->setTitle(QCoreApplication::translate("MainWindow", "TUN\350\256\276\345\244\207", nullptr));
        refreshInterfaces->setText(QCoreApplication::translate("MainWindow", "\345\210\267\346\226\260", nullptr));
